#!/usr/bin/env python3
"""
MaFi Dataset - Step 2: Generate File Lists
==========================================

Generate file.list and label.list from processed MaFi videos.
...
parser = argparse.ArgumentParser(description="Generate file lists for MaFi dataset")
parser.add_argument(
    "--mafi-data-dir",
    type=str,
    required=True,
...
if "face_224x224" in str(data_dir):
    text_dir = data_dir.parent / "mafi_text_face_224x224"
else:
    text_dir = data_dir.parent / "mafi_text"
