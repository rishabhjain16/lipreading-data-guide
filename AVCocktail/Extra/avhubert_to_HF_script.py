...
### as described in https://github.com/nguyenvulebinh/AV-HuBERT-S2S/blob/main/src/export_muavic_checkpoint_to_hf.py
# Not tested
...
# From : https://github.com/nguyenvulebinh/AV-HuBERT-S2S/blob/main/src/export_muavic_checkpoint_to_hf.py
# import torch
